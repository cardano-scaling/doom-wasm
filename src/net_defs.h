...
typedef enum
{
    NET_PACKET_TYPE_SYN,                    // 0
    NET_PACKET_TYPE_ACK, // deprecated      // 1
    NET_PACKET_TYPE_REJECTED,               // 2
    NET_PACKET_TYPE_KEEPALIVE,              // 3
    NET_PACKET_TYPE_WAITING_DATA,           // 4
    NET_PACKET_TYPE_GAMESTART,              // 5
    NET_PACKET_TYPE_GAMEDATA,               // 6
    NET_PACKET_TYPE_GAMEDATA_ACK,           // 7
    NET_PACKET_TYPE_DISCONNECT,             // 8
    NET_PACKET_TYPE_DISCONNECT_ACK,         // 9
    NET_PACKET_TYPE_RELIABLE_ACK,           // 10
    NET_PACKET_TYPE_GAMEDATA_RESEND,        // 11
    NET_PACKET_TYPE_CONSOLE_MESSAGE,        // 12
    NET_PACKET_TYPE_QUERY,                  // 13
    NET_PACKET_TYPE_QUERY_RESPONSE,         // 14
    NET_PACKET_TYPE_LAUNCH,                 // 15
